...
% Save result to file
save XRsparse_aTV_JTV_Bone recn1 recn2 alpha target1 target2 obj
%% Calculate the error
% Target 1
...
im4 = im4-MIN;
im4 = im4/(MAX-MIN);
imwrite(uint8(255*im3),'JTV_reco_Bone1.png')
imwrite(uint8(255*im4),'JTV_reco2_Bone2.png')
...
save JTV_Bone_for_segmentations im1 im2 im3 im4 N
