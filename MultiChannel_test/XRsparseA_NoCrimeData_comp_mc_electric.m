...
% electric phantom
target1 = imread('phantom_electric1.bmp');
target2 = imread('phantom_electric2.bmp');
...
% Save result to file
save XRsparse_aTV_JTV_electric recn1 recn2 alpha target1 target2 obj
...
XRsparseD_aTV_plot_modified_electric
...
im4 = im4-MIN;
im4 = im4/(MAX-MIN);
imwrite(uint8(255*im3),'JTV_reco_electric1.png')
imwrite(uint8(255*im4),'JTV_reco_electric2.png')
...
save JTV_electric_for_segmentations im1 im2 im3 im4 N
