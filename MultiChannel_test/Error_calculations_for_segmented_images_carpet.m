...
% CARPET THRESHOLD: 0.3492
im3_thresholded = im3;
im3_thresholded(im3>0.3492) = 1;
im3_thresholded(im3<0.3492) = 0;
nnz(im3_thresholded)
...
% CARPET TRESHOLD: 0.2762
im4_thresholded = im4;
im4_thresholded(im4>0.2762) = 1;
im4_thresholded(im4<0.2762) = 0;
nnz(im4_thresholded)
