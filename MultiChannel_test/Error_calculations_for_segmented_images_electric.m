...
% electric phantom
load XRsparse_aTV_JTV_electric recn1 recn2 target1 target2 obj
load JTV_electric_for_segmentations im1 im2 im3 im4 N
% figure(1)
...
% electric TRESHOLD: 0.3354
im3_thresholded = recn1;
im3_thresholded(im3>0.355) = 1;
im3_thresholded(im3<0.355) = 0;
...
axis square;
axis off;
title({'electric1 phantom, Ground truth'});
...
axis square;
axis off;
title({'electric2 phantom, Ground truth '});
...
% Image = getframe(gcf);
% imwrite(Image.cdata, 'segmentations_electric_JTV.jpg');
...
save color_segmentations_JTV_Electric pha pha1 pha2 im im1 im2