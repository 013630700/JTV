...
% Maya phantom
load XRsparse_aTV_JTV_HY recn1 recn2 target1 target2 obj
load JTV_HY_for_segmentations im1 im2 im3 im4 N
% % figure(1)
...
im3_thresholded = im3;
im3_thresholded(im3>0.000000000000000001) = 1;
im3_thresholded(im3<0.000000000000000001) = 0;
nnz(im3_thresholded)
...
% axis square;
% axis off;
% title({'Hy1 phantom, ground truth'});
...
% axis square;
% axis off;
% title({'Hy2 phantom, ground truth '});
...
% 
% Image = getframe(gcf);
% imwrite(Image.cdata, 'segmentations_HY_JTV.jpg');