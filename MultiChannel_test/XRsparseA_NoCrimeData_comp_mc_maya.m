...
XRsparseD_aTV_plot_modified_maya
...
im4 = im4-MIN;
im4 = im4/(MAX-MIN);
imwrite(uint8(255*im3),'JTV_reco_maya1.png')
imwrite(uint8(255*im4),'JTV_reco_maya2.png')
...
axis square;
axis off;
title({'Phantom Maya 1, Ground truth'});
...
axis square;
axis off;
title({'Phantom Maya2, Ground truth'});
