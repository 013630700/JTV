...
function f = XR_aTV_feval_modified(x,m,measang,alpha,beta,M,c11,c12,c21,c22)

f = XR_misfit_modified(x,m,measang,M,c11,c12,c21,c22) + alpha*XR_aTV_modified(x,beta);
