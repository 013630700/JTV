...
function grad = XR_aTV_fgrad_modified_regterm(x,m,ang,corxn,alpha,beta,c11,c12,c21,c22,M,N,gamma)

grad = XR_misfit_grad_modified(x,m,ang,corxn,c11,c12,c21,c22,M) + alpha*XR_aTV_grad(x,beta) + gamma*new_reg(x,N);
