...
target1 = imresize((imread('phantom_boneA.jpg')), [M M]);
target2 = imresize((imread('phantom_boneB.jpg')), [M M]);
...
mncn  = A2x2mult_matrixfree(c11,c12,c21,c22,x,ang,M);%This is the data m?
...
%load XRsparse_NoCrime N mnc mncn measang target%Tässä jo menee pieleen jos ja kun sinogrammi on vain yhdestä kuvasta
...
gold   = XR_aTV_fgrad_modified_no_regterm(fold,mncn,ang,corxn,alpha,beta,c11,c12,c21,c22,M,N,gamma);
...
gnew = XR_aTV_fgrad_modified_no_regterm(fnew,mncn,ang,corxn,alpha,beta,c11,c12,c21,c22,M,N,gamma);     
